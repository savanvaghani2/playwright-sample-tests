...
class CheckoutPage extends BasePage {
  ...
  async assertCheckoutTitle() {
    await expect(this.page.getByTestId(this.locators.shippingAddress.checkoutTitle)).toBeVisible({
      timeout: 10000,
    });
  }
  ...
  getShippingAddressStreetAddress() {
    return this.page.getByTestId(
      this.locators.shippingAddress.checkoutShippingAddressStreetAddress,
    );
  }
  ...
  async assertOrderSummaryTitle() {
    await expect(
      this.page.getByTestId(this.locators.orderSummary.checkoutOrderSummaryTitle),
    ).toBeVisible();
  }
  ...
  async verifyProductInCheckout(productName) {
    const locator = this.page
      .locator(this.locators.productNameInCheckout.replace('{}', productName))
      .nth(1);
  ...
  async verifyOrderItemName(productName) {
    ...
    await expect(this.page.locator(this.locators.orderItemNameConfirmation)).toHaveText(
      productName,
    );
  }

  async verifyOrderConfirmedTitle() {
    await expect(this.page.locator(this.locators.orderConfirmedTitle)).toBeVisible({
      timeout: 50000,
    });
  }
